function [output, table] = decoder(vector)
%   decoder(X) returns the uncompressed vector of X using the LZW algorithm.
%   [output, table] = decoder(X) returns also the table that the algorithm produces.
